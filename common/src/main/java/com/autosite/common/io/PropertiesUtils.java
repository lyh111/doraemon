/**
 * Copyright (c) 2013-Now http://autosite.com All rights reserved.
 */
package com.autosite.common.io;
...
public class PropertiesUtils {
    ...
    public static final String[] DEFAULT_CONFIG_FILE = new String[]{
            "classpath:application.yml", "classpath:application-*.yml","classpath:beetl.properties","classpath:config/application.yml", "classpath:config/application-*.yml"};
...
//			}
//			configSet.add("classpath:config/application.yml");
            ...
            logger.debug("Loading autosite config: {}", (Object) configFiles);
