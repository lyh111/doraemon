 ...
 */
package com.autosite.common.lang;
...
//		String yyyyMM = new SimpleDateFormat("yyyyMM").format(date);
     ...
     * @param day     计算方式：默认从本周周一开始计算之间相差的天数
     *                *例：上周一到本周一相差7天，day=-7
     * @return
     * @throws Exception
     */
    public static Date getDateByDay(String pattern, int day) throws Exception {
        ...
        if (StringUtils.isNotBlank(pattern)) {
            ...
            String dayS = sdf.format(friDay);
            friDay = sdf.parse(dayS);
            return friDay;
        } else {
            return friDay;
        }
