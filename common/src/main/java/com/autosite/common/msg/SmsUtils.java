package com.autosite.common.msg;
...
//		String phone = "18625506113"; // 收短信人手机号码；例如:18500000000  支持多号码，号码之间用英文逗号隔开，最多100个
//		String content = "您好，您的验证码是：1932（请勿透露给其他人）感谢您的使用。"; // 输入需要发送内容；例如：你好这是一条测试短信
